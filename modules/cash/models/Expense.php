            ...
            Yii::$app->telegram->sendMessage([
                ...
                "reply_markup" => json_encode(["inline_keyboard" => [
                    [
                        [
                            "text" => "Очиб кориш",
                            "url" => "http://" . $_SERVER['SERVER_NAME'] . \Yii::$app->getUrlManager()->createUrl(['cash/expense/index', 'ExpenseSearch[id]' => $this->id])
                        ]
                    ]
                ]])
            ]);
